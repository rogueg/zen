...
module.exports = class Server {
  ...
  sendStatus () {
    const { hash, status, errors, percentage, message } = Zen.webpack.compile
    const { runId, results, isLambda, workerCount, passedFocus } = this
    Util.wsSend(this.head,
      {
        runId,
        results,
        isLambda,
        ...
        compile: { hash, status, errors, percentage, message } // exclude files array, which has contains content
      }
    )
  }
}
