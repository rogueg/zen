...
import {getPackages, adjustToTerminalWidth, OK} from './buildUtils'
//import browserBuild = require('./browserBuild');
...
const PACKAGES_DIR = path.resolve(__dirname, '../lib');
...
function buildFile(file, silent=false) {
